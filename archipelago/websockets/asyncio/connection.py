...
from ..http11 import Headers, Request, Response
...
class Connection(asyncio.Protocol):
    ...
    def closed(self) -> bool:
        ...
        This property is provided for compatibility with the legacy API.
    ...
    def extensions(self) -> list[Extension]:
        """
        List of extensions negotiated during the opening handshake.

        This property is provided for compatibility with the legacy API.

        """
        return self.protocol.extensions
