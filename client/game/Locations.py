...
security_camera_table: dict[str, P2CELocationData] = {
    "Security Camera 1": P2CELocationData("sp_a1_intro3", LocationType.SECURITY_CAMERA, []),
    "Security Camera 2": P2CELocationData("sp_a1_intro4", LocationType.SECURITY_CAMERA, []),
    "Security Camera 3": P2CELocationData("sp_a1_intro4", LocationType.SECURITY_CAMERA, []),
    "Security Camera 4": P2CELocationData("sp_a1_intro4", LocationType.SECURITY_CAMERA, [weighted_cube, floor_button]),
    "Security Camera 5": P2CELocationData("sp_a1_intro6", LocationType.SECURITY_CAMERA, []),
    "Security Camera 6": P2CELocationData("sp_a1_intro6", LocationType.SECURITY_CAMERA, []),
    "Security Camera 7": P2CELocationData("sp_a1_intro6", LocationType.SECURITY_CAMERA, [weighted_cube, floor_button]),
    "Security Camera 8": P2CELocationData("sp_a2_intro", LocationType.SECURITY_CAMERA, [portal_gun_2]),
    "Security Camera 9": P2CELocationData("sp_a2_laser_stairs", LocationType.SECURITY_CAMERA, [portal_gun_2]),
    "Security Camera 10": P2CELocationData("sp_a2_dual_lasers", LocationType.SECURITY_CAMERA, [portal_gun_2]),
    "Security Camera 11": P2CELocationData("sp_a2_catapult_intro", LocationType.SECURITY_CAMERA, [portal_gun_2]),
    "Security Camera 12": P2CELocationData("sp_a2_catapult_intro", LocationType.SECURITY_CAMERA, [portal_gun_2]),
    "Security Camera 13": P2CELocationData("sp_a2_fizzler_intro", LocationType.SECURITY_CAMERA, [portal_gun_2]),
    "Security Camera 14": P2CELocationData("sp_a2_bridge_intro", LocationType.SECURITY_CAMERA, [portal_gun_2]),
    "Security Camera 15": P2CELocationData("sp_a2_bridge_the_gap", LocationType.SECURITY_CAMERA, [portal_gun_2]),
    "Security Camera 16": P2CELocationData("sp_a2_turret_intro", LocationType.SECURITY_CAMERA, [portal_gun_2, turrets]),
    "Security Camera 17": P2CELocationData("sp_a2_turret_intro", LocationType.SECURITY_CAMERA, [portal_gun_2, turrets]),
    "Security Camera 18": P2CELocationData("sp_a2_laser_relays", LocationType.SECURITY_CAMERA, [portal_gun_2]),
    "Security Camera 19": P2CELocationData("sp_a2_turret_blocker", LocationType.SECURITY_CAMERA, [portal_gun_2, turrets, bridge]),
    "Security Camera 20": P2CELocationData("sp_a2_turret_blocker", LocationType.SECURITY_CAMERA, [portal_gun_2, turrets, bridge]),
...
sub_locations_in_maps: dict[str, list[str]] = {
    ...
    "Incinerator Completion": [portal_gun_2, "Security Camera 8"],
    ...
    "Smooth Jazz Completion": ["Ratman Den 1", "Security Camera 2", "Security Camera 3", "Security Camera 4"],
    "Future Starter Completion": ["Security Camera 5", "Security Camera 6", "Security Camera 7"],
    "Laser Stairs Completion": ["Security Camera 9"],
    "Dual Lasers Completion": ["Ratman Den 2", "Security Camera 10"],
    "Catapult Intro Completion": ["Security Camera 11", "Security Camera 12"],
    "Fizzler Intro Completion": ["Security Camera 13"],
    "Trust Fling Completion": ["Ratman Den 3"],
    "Bridge Intro Completion": ["Ratman Den 4", "Security Camera 14"],
    "Bridge the Gap Completion": ["Ratman Den 5", "Security Camera 15"],
    "Turret Intro Completion": ["Security Camera 16", "Security Camera 17"],
    "Laser Relays Completion": ["Security Camera 18"],
    "Turret Blocker Completion": ["Security Camera 19", "Security Camera 20"],
    "Laser Vs. Turret Completion": ["Ratman Den 6", "Security Camera 21"],
    "Pull The Rug Completion": ["Ratman Den 7", "Security Camera 22"],
    "Laser Chaining Completion": ["Security Camera 23"],
    "Triple Laser Completion": ["Security Camera 24"],
