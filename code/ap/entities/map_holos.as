void CreateMapSpecificHolos(string current_map) {
    ...
    if (current_map == "sp_a1_intro3") {
        CreateAPHologram(Vector(25, 1958, -267), QAngle(0, 0, 0), 0.66f, "", "", 0);
        ...
        if (gun_trigger !is null) {
            ...
            pos.z += 32.0f;
            CreateAPHologram(pos, QAngle(0, 0, 0), 0.66f, "", "", 0);
        } else {
    ...
    // NOTE: This logic is now handled in the main sv_init bootstrap to prevent double-firing
