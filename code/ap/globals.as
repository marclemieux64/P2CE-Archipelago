...
int g_NastyTextTicks = 0;
array<float> g_NastyX(BLOCK_COUNT);
array<float> g_NastyY(BLOCK_COUNT);
array<float> g_NastyDX(BLOCK_COUNT);
array<float> g_NastyDY(BLOCK_COUNT);
array<int> g_ColorPhase(BLOCK_COUNT);
...
void RunButtonScenarioCheck(string buttonName) {
    ...
    if (buttonName == "rd1")      Msgl("button_check:Ratman Den 1"); 
    else if (buttonName == "rd2") Msgl("button_check:Ratman Den 2"); 
    else if (buttonName == "rd3") Msgl("button_check:Ratman Den 3"); 
    else if (buttonName == "rd4") Msgl("button_check:Ratman Den 4"); 
    else if (buttonName == "rd5") Msgl("button_check:Ratman Den 5"); 
    else if (buttonName == "rd6") Msgl("button_check:Ratman Den 6"); 
    else if (buttonName == "rd7") Msgl("button_check:Ratman Den 7"); 
    else                       Msgl("button_check:unknown_" + buttonName);
}
