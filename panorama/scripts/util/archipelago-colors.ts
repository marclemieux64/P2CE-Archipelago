...
class ArchipelagoColors {
    ...
    static g_WheatleyRequirements: { [key: string]: string[][] } = {
        ...
        "sp_a4_jump_polarity": [["û", "à", "â", "å", "ó", "æ", "ñ"]], "sp_a4_finale3": [["û", "á", "â"]]
    };
...
(UiToolkitAPI.GetGlobalObject() as any).ArchipelagoColors = ArchipelagoColors;
$.Msg("[AP] ArchipelagoColors loaded");
