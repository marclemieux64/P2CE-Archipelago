...
//////////////////////////////////////////////////////////////////////
	...
	"player_death"				// a game event, name may be 32 charaters long
	{
		...
		"attacker"	"short"	 	// user ID who killed (0 if not a player)
		"weapon"	"string"	// classname of weapon used, or killing entity if not a player
	}
	...
	// Weapons equipped on the player
	"player_equip"
	{
		"userid"    "short"
		"classname"	"string"  // Classname of the weapon
	}

	// All weapons removed from the player
	"player_weapons_removed"
	{
		"userid"	"short"
	}
